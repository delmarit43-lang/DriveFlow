...
import { localeMeta, type LocaleCode } from "@/i18n/translations";
  ...
  return (
    <div className="mx-auto max-w-[1100px]">
      <PageHeader
        ...
        breadcrumbs={[{ label: t("common.dashboard"), href: "/" }, { label: t("page.settings.title") }]}
      />

      <Tabs defaultValue="company">
        <TabsList className="flex-wrap">
          <TabsTrigger value="company">{t("settings.company")}</TabsTrigger>
          <TabsTrigger value="fleet">{t("settings.pricing")}</TabsTrigger>
        ...
        <TabsContent value="appearance" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Palette className="size-5 text-primary" /> {t("settings.appearance")}
              </CardTitle>
              ...
              <Field label={t("settings.interfaceLanguage")} hint={t("settings.languageHint")}>
                <Select
                  ...
                  onValueChange={(v) => {
                    ...
                    setLocale(code);
                    toast({
                      title: t("topbar.languageUpdated"),
                      description: t("topbar.interfaceSetTo", { label: localeMeta[code].nativeLabel }),
                      tone: "success",
                    });
                  }}
                >
