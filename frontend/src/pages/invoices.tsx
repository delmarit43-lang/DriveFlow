...
import { fleetKeys } from "@/store/fleet-store";
  ...
  return (
    <div className="mx-auto max-w-[1200px] space-y-8">
      <PageHeader
        ...
        description={t("page.invoices.desc")}
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        ...
        <StatCard
          ...
          hint={totals.overdue > 0 ? <Badge variant="danger">Follow up</Badge> : <Badge variant="success">All settled</Badge>}
        />
      </section>
