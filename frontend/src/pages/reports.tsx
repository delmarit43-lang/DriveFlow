...
export default function ReportsPage() {
  ...
  const dashboardStats = analytics?.dashboardStats ?? { utilizationRate: 0 };
  ...
  const mostRentedVehicles = analytics?.mostRentedVehicles ?? [];
                  ...
                  <TR key={v.name}>
                    ...
                    <TD>
                      <div className="flex items-center gap-3">
                        <Progress
                          value={
                            mostRentedVehicles[0]?.rentals
                              ? (v.rentals / mostRentedVehicles[0].rentals) * 100
                              : 0
                          }
                          className="w-24"
                        />
