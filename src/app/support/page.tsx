...
const channels = [
  { icon: Mail, label: "Email support", detail: "support@driveflow.com", meta: "Replies within 4 hours" },
  { icon: Phone, label: "Priority phone line", detail: "+1 (555) 010-4400", meta: "Mon–Fri, 07:00–20:00 ET" },
...
export default function SupportPage() {
  ...
  return (
    <div className="mx-auto max-w-[1100px] space-y-8">
      <PageHeader
        title="Support"
        description="Get help from the DriveFlow enterprise team."
